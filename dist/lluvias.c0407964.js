...
})({"cMhdf":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "f3fe9130c0407964";
"use strict";
...
},{}],"aIcj4":[function(require,module,exports,__globalThis) {
// js/simulationCore.js
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "SimulationCore", ()=>SimulationCore);
class SimulationCore {
     ...
     */ _computeRiskMap(waterMap, heightMap) {
        ...
        for(let i = 0; i < len; i++){
            ...
            let landslideRisk = 0;
            if (terrain > 0.5 && water > 0.05) landslideRisk = (terrain - 0.5) * 2 + (water - 0.05) * 3; // Terrain contribution + water contribution
     ...
     */ _applyDrainage(currentWaterMap, heightMap, gridResolution) {
        ...
        for(let y = 0; y < h; y++)for(let x = 0; x < w; x++){
            ...
            for (const [nx, ny] of neighbors)if (nx >= 0 && nx < w && ny >= 0 && ny < h) {
                const nidx = ny * w + nx;
            ...
            if (downstreamIdx !== -1 && heightMap[idx] + cellWater > minNeighborHeight + 0.001) // Apply a fraction of the drained water to the downstream cell
    ...
    updateSimulation() {
        ...
        this.waterMap = this._applyRainfallAndInfiltration(this.waterMap, this.heightMap, this.cloudMap, this.RAINFALL_AMOUNT, this.BASE_INFILTRATION_RATE, this.MAX_WATER_HEIGHT, this.NUM_RAINDROPS_PER_FRAME);
        // Paso 2: Simular el flujo de agua
        // Se llama a la función pura y se asigna el resultado a this.waterMap
        this.waterMap = this._simulateWaterFlow(this.waterMap, this.heightMap, this.gridResolution, this.FLOW_RATE_FACTOR);
        // Paso 3: Aplicar drenaje y acumulación en cuencas (el snippet de abajo)
        // Se llama a la función pura y se asigna el resultado a this.waterMap
        this.waterMap = this._applyDrainage(this.waterMap, this.heightMap, this.gridResolution);
    ...
    getSettings() {
        return {
            ...
            showClouds: this.SHOW_CLOUDS,
            baseInfiltrationRate: this.BASE_INFILTRATION_RATE
        };
    }
    // Setters for controls to modify simulation parameters
    setRainfallAmount(amount) {
        this.RAINFALL_AMOUNT = amount;
    }
    setCloudinessFactor(factor) {
        this.CLOUDINESS_FACTOR = factor;
    }
    setFlowRateFactor(factor) {
        this.FLOW_RATE_FACTOR = factor;
    }
    setBaseInfiltrationRate(rate) {
        this.BASE_INFILTRATION_RATE = rate;
    }
    setShowClouds(show) {
        this.SHOW_CLOUDS = show;
    }
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["cMhdf","aIcj4"], "aIcj4", "parcelRequire4e56", {})

//# sourceMappingURL=lluvias.c0407964.js.map
